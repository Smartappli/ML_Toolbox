...
ts_naive = ttk.Checkbutton(ts_model, text="Naive Forecaster (naive)", variable=models["ts_naive"], onvalue=1, offvalue=0)
ts_naive.grid(row=0, column=0, sticky=(tk.W + tk.E))

models["ts_grand_means"] = tk.BooleanVar()
ts_grand_means = ttk.Checkbutton(ts_model, text="Grand Means Forecaster (grand_means)",
...
ts_snaive = ttk.Checkbutton(ts_model, text="Seasonal Naive Forecaster (snaive)", variable=models["ts_snaive"], onvalue=1,
                            offvalue=0)
ts_snaive.grid(row=0, column=2, sticky=(tk.W + tk.E))

models["ts_polytrend"] = tk.BooleanVar()
ts_polytrend = ttk.Checkbutton(ts_model, text="Polynomial Trend Forecaster (polytrend)", variable=models["ts_polytrend"],
                               onvalue=1, offvalue=0)
ts_polytrend.grid(row=0, column=3, sticky=(tk.W + tk.E))

models["ts_arima"] = tk.BooleanVar()
ts_arima = ttk.Checkbutton(ts_model, text="ARIMA (arima)", variable=models["ts_arima"], onvalue=1, offvalue=0)
ts_arima.grid(row=1, column=0, sticky=(tk.W + tk.E))

models["ts_auto_arima"] = tk.BooleanVar()
ts_auto_arima = ttk.Checkbutton(ts_model, text="Auto ARIMA (auto_arima)", variable=models["ts_auto_arima"], onvalue=1,
                                offvalue=0)
ts_auto_arima.grid(row=1, column=1, sticky=(tk.W + tk.E))

models["ts_exp_smooth"] = tk.BooleanVar()
ts_exp_smooth = ttk.Checkbutton(ts_model, text="Exponential Smoothing (exp_smooth)", variable=models["ts_exp_smooth"],
                                onvalue=1, offvalue=0)
ts_exp_smooth.grid(row=1, column=2, sticky=(tk.W + tk.E))

models["ts_ets"] = tk.BooleanVar()
ts_ets = ttk.Checkbutton(ts_model, text="ETS (ets)", variable=models["ts_ets"], onvalue=1, offvalue=0)
ts_ets.grid(row=1, column=3, sticky=(tk.W + tk.E))

models["ts_theta"] = tk.BooleanVar()
ts_theta = ttk.Checkbutton(ts_model, text="Theta Forecaster (theta)", variable=models["ts_theta"], onvalue=1, offvalue=0)
ts_theta.grid(row=2, column=0, sticky=(tk.W + tk.E))

models["ts_stlf"] = tk.BooleanVar()
ts_stlf = ttk.Checkbutton(ts_model, text="STLF (stlf)", variable=models["ts_stlf"], onvalue=1, offvalue=0)
ts_stlf.grid(row=2, column=1, sticky=(tk.W + tk.E))

models["ts_croston"] = tk.BooleanVar()
ts_croston = ttk.Checkbutton(ts_model, text="Croston (croston)", variable=models["ts_croston"], onvalue=1, offvalue=0)
ts_croston.grid(row=2, column=2, sticky=(tk.W + tk.E))

models["ts_bats"] = tk.BooleanVar()
ts_bats = ttk.Checkbutton(ts_model, text="BATS (bats)", variable=models["ts_bats"], onvalue=1, offvalue=0)
ts_bats.grid(row=2, column=3, sticky=(tk.W + tk.E))

models["ts_tbats"] = tk.BooleanVar()
ts_tbats = ttk.Checkbutton(ts_model, text="TBATS (tbats)", variable=models["ts_tbats"], onvalue=1, offvalue=0)
...
ts_en_cds_dt = ttk.Checkbutton(ts_model, text="Elastic Net w/ Cond. Deseasonalize & Detrending (en_cds_dt)",
...
ts_ridge_cds_dt = ttk.Checkbutton(ts_model, text="Ridge w/ Cond. Deseasonalize & Detrending (ridge_cds_dt)",
...
ts_lasso_cds_dt = ttk.Checkbutton(ts_model, text="Lasso w/ Cond. Deseasonalize & Detrending (lasso_cds_dt)",
...
ts_lar_cds_dt = ttk.Checkbutton(ts_model,
...
ts_llar_cds_dt = ttk.Checkbutton(ts_model,
...
ts_br_cds_dt = ttk.Checkbutton(ts_model, text="Bayesian Ridge w/ Cond. Deseasonalize & Detrending (bs_cds_dt)",
...
ts_huber_cds_dt = ttk.Checkbutton(ts_model, text="Huber w/ Cond. Deseasonalize & Detrending (huber_cds_dt)",
...
ts_par_cds_dt = ttk.Checkbutton(ts_model, text="Passive Aggressive w/ Cond. Deseasonalize & Detrending (par_cds_dt)",
...
ts_omp_cds_dt = ttk.Checkbutton(ts_model,
...
ts_knn_cds_dt = ttk.Checkbutton(ts_model, text="K Neighbors w/ Cond. Deseasonalize & Detrending (knn_cds_dt)",
...
ts_dt_cds_dt = ttk.Checkbutton(ts_model, text="Decision Tree w/ Cond. Deseasonalize & Detrending (dt_cds_dt)",
...
ts_rf_cds_dt = ttk.Checkbutton(ts_model, text="Random Forest w/ Cond. Deseasonalize & Detrending (rf_cds_dt)",
...
ts_rf_cds_dt = ttk.Checkbutton(ts_model, text="Extra Trees w/ Cond. Deseasonalize & Detrending (et_cds_dt)",
...
ts_gbr_cds_dt = ttk.Checkbutton(ts_model, text="Gradient Boosting w/ Cond. Deseasonalize & Detrending (gbr_cds_dt)",
...
ts_ada_cds_dt = ttk.Checkbutton(ts_model, text="AdaBoost w/ Cond. Deseasonalize & Detrending (ada_cds_dt)",
...
ts_xgboost_cds_dt = ttk.Checkbutton(ts_model,
...
ts_catboost_cds_dt = ttk.Checkbutton(ts_model,
...
ts_feature = ttk.Checkbutton(ts_output, text="Forecast", variable=models_output["forecast"], onvalue=True, offvalue=False)
ts_feature.grid(row=0, column=0, sticky=(tk.W + tk.E))

models_output["residuals"] = tk.BooleanVar()
ts_residuals = ttk.Checkbutton(ts_output, text="Residuals", variable=models_output["residuals"], onvalue=True, offvalue=False)
ts_residuals.grid(row=0, column=1, sticky=(tk.W + tk.E))
...
ttk.Button(ts_action, text="Select All", command=selectAllTS).grid(row=8, column=0, padx=5, pady=5, sticky=(tk.W + tk.E))
ttk.Button(ts_action, text="unselect All", command=unselectAllTS).grid(row=8, column=1, padx=5, pady=5,
                                                                     sticky=(tk.W + tk.E))
ttk.Button(ts_action, text="Run comparison", command=run).grid(row=8, column=3, padx=5, pady=5, sticky=(tk.W + tk.E))
