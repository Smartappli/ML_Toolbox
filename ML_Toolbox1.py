...
regression_lasso = ttk.Checkbutton(regression_model, text="Lasso Regression (lasso)",
                                   variable=models1["regression_lasso"], onvalue=True, offvalue=False)
...
regression_ridge = ttk.Checkbutton(regression_model, text="Ridge Regression (ridge)",
                                   variable=models1["regression_ridge"], onvalue=True, offvalue=False)
regression_ridge.grid(row=0, column=2, sticky=(tk.W + tk.E))

models1["regression_en"] = tk.BooleanVar()
regression_en = ttk.Checkbutton(regression_model, text="Elastic Net (en)", variable=models1["regression_en"], onvalue=True,
                                offvalue=False)
...
regression_lar = ttk.Checkbutton(regression_model, text="Least Angle Regression (lar)",
                                 variable=models1["regression_lar"], onvalue=True, offvalue=False)
...
regression_llar = ttk.Checkbutton(regression_model, text="Lasso Least Angle Regression (llar)",
                                  variable=models1["regression_llar"], onvalue=True, offvalue=False)
...
regression_omp = ttk.Checkbutton(regression_model, text="Orthogonal Matching Pursuit (omp)",
                                 variable=models1["regression_omp"], onvalue=True, offvalue=False)
...
regression_ard = ttk.Checkbutton(regression_model, text="Automatic Relevance Determination (ard)",
                                 variable=models1["regression_ard"], onvalue=True, offvalue=False)
...
regression_par = ttk.Checkbutton(regression_model, text="Passive Aggressive Regressor (par)",
                                 variable=models1["regression_par"], onvalue=True, offvalue=False)
...
regression_ransac = ttk.Checkbutton(regression_model, text="Random Sample Consensus (ransac)",
                                    variable=models1["regression_ransac"], onvalue=True, offvalue=False)
...
regression_huber = ttk.Checkbutton(regression_model, text="Huber Regressor (huber)",
                                   variable=models1["regression_huber"], onvalue=True, offvalue=False)
regression_huber.grid(row=3, column=0, sticky=(tk.W + tk.E))

models1["regression_kr"] = tk.BooleanVar()
regression_kr = ttk.Checkbutton(regression_model, text="Kernel Ridge (kr)", variable=models1["regression_kr"], onvalue=True,
                                offvalue=False)
...
regression_svm = ttk.Checkbutton(regression_model, text="Support Vector Regression (svm)",
                                 variable=models1["regression_svm"], onvalue=True, offvalue=False)
...
regression_knn = ttk.Checkbutton(regression_model, text="K Neighbors Regressor (knn)",
                                 variable=models1["regression_knn"], onvalue=True, offvalue=False)
...
regression_gbr = ttk.Checkbutton(regression_model, text="Gradient Boosting Regressor (gbr)",
                                 variable=models1["regression_gbr"], onvalue=True, offvalue=False)
...
regression_lightgbm = ttk.Checkbutton(regression_model, text="Light Gradient Boosting Machine (lightgbm)",
                                      variable=models1["regression_lightgbm"], onvalue=True, offvalue=False)
...
regression_dummy = ttk.Checkbutton(regression_model, text="Dummy Regressor (dummy)",
                                   variable=models1["regression_dummy"], onvalue=True, offvalue=False)
...
regression_bagging = ttk.Checkbutton(regression_model, text="Bagging Regressor (bagging)",
                                     variable=models1["regression_bagging"], onvalue=True, offvalue=False)
...
regression_stacking = ttk.Checkbutton(regression_model, text="Stacking Regressor (stacking)",
                                      variable=models1["regression_stacking"], onvalue=True, offvalue=False)
...
regression_voting = ttk.Checkbutton(regression_model, text="Voting Regressor (voting)",
                                    variable=models1["regression_voting"], onvalue=True, offvalue=False)
...
regression_error = ttk.Checkbutton(regression_output, text="Error", variable=models1_output["error"], onvalue=True, offvalue=False)
...
regression_action.grid(padx=5, pady=5, sticky=(tk.W + tk.E))
for i in range(4):
    regression_action.columnconfigure(i, weight=1)


ttk.Button(regression_action, text="Select All", command=selectAllRegression).grid(row=8, column=0, padx=5, pady=5,
                                                                                 sticky=(tk.W + tk.E))
ttk.Button(regression_action, text="Unselect All", command=unselectAllRegression).grid(row=8, column=1, padx=5, pady=5,
                                                                                     sticky=(tk.W + tk.E))
ttk.Button(regression_action, text="Run Comparison", command=run1).grid(row=8, column=3, padx=5, pady=5,
                                                                      sticky=(tk.W + tk.E))
...
classification_lr = ttk.Checkbutton(classification_info, text="Logistic Regression (lr)",
                                    variable=models2["classification_lr"], onvalue=True, offvalue=False)
...
classification_knn = ttk.Checkbutton(classification_info, text="K Neightbors Classifier (knn)",
                                     variable=models2["classification_knn"], onvalue=True, offvalue=False)
...
classification_nb = ttk.Checkbutton(classification_info, text="Gaussian Naive Bayes (nb)",
                                    variable=models2["classification_nb"], onvalue=True, offvalue=False)
...
classification_dt = ttk.Checkbutton(classification_info, text="Decision Tree Classifier (dt)",
                                    variable=models2["classification_dt"], onvalue=True, offvalue=False)
...
classification_svm = ttk.Checkbutton(classification_info, text="SVM - Linear Kernel (svm)",
                                     variable=models2["classification_svm"], onvalue=True, offvalue=False)
...
classification_rbfsvm = ttk.Checkbutton(classification_info, text="SVM - Radial Kernel (rbfsvm)",
                                        variable=models2["classification_rbfsvm"], onvalue=True, offvalue=False)
...
classification_gpc = ttk.Checkbutton(classification_info, text="Gaussian Process Classifier (gpc)",
                                     variable=models2["classification_gpc"], onvalue=True, offvalue=False)
...
classification_mlp = ttk.Checkbutton(classification_info, text="MLP Classifier (mlp)",
                                     variable=models2["classification_mlp"], onvalue=True, offvalue=False)
...
classification_ridge = ttk.Checkbutton(classification_info, text="Ridge Classifier (ridge)",
                                       variable=models2["classification_ridge"], onvalue=True, offvalue=False)
...
classification_rf = ttk.Checkbutton(classification_info, text="Random Forest Classifier (rf)",
                                    variable=models2["classification_rf"], onvalue=True, offvalue=False)
...
classification_qda = ttk.Checkbutton(classification_info, text="Quadratic Discriminant Analysis (qda)",
                                     variable=models2["classification_qda"], onvalue=True, offvalue=False)
...
classification_ada = ttk.Checkbutton(classification_info, text="Ada Boost Classifier (ada)",
                                     variable=models2["classification_ada"], onvalue=True, offvalue=False)
...
classification_gbc = ttk.Checkbutton(classification_info, text="Grandient Boost Classifier (bgc)",
                                     variable=models2["classification_gbc"], onvalue=True, offvalue=False)
...
classification_lda = ttk.Checkbutton(classification_info, text="Linear Discriminant Analysis (lda)",
                                     variable=models2["classification_lda"], onvalue=True, offvalue=False)
...
classification_et = ttk.Checkbutton(classification_info, text="Extra Trees Classifier (et)",
                                    variable=models2["classification_et"], onvalue=True, offvalue=False)
...
classification_lightgbm = ttk.Checkbutton(classification_info, text="light Gradient Boosting Machine (lightgbm)",
                                          variable=models2["classification_lightgbm"], onvalue=True, offvalue=False)
...
classification_dummy = ttk.Checkbutton(classification_info, text="Dummy Classifier (dummy)",
                                       variable=models2["classification_dummy"], onvalue=True, offvalue=False)
classification_dummy.grid(row=4, column=2, sticky=(tk.W + tk.E))


classification_output = ttk.LabelFrame(mc, text='Output')
classification_output.grid(padx=5, pady=5, sticky=(tk.W + tk.E))
for i in range(4):
...
def run2():
    ...
    ttk.Label(classification_info, text="Selected Models: " + ", ".join(str(x) for x in models2_to_compare)).grid(row=0,
                                                                                                              column=0)
...
classification_action.grid(padx=5, pady=5, sticky=(tk.W + tk.E))
for i in range(4):
    classification_action.columnconfigure(i, weight=1)

ttk.Button(classification_action, text="Select All", command=selectAllClassification).grid(row=5, column=0, padx=5,
                                                                                         pady=5, sticky=(tk.W + tk.E))
ttk.Button(classification_action, text="Unselect All", command=unselectAllClassification).grid(row=5, column=1, padx=5,
                                                                                             pady=5,
                                                                                             sticky=(tk.W + tk.E))
ttk.Button(classification_action, text="Run comparison", command=run2).grid(row=5, column=3, padx=5, pady=5,
                                                                          sticky=(tk.E + tk.W))
